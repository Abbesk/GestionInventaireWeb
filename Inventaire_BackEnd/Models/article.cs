...
namespace Inventaire_BackEnd.Models
{
    ...
    public partial class article
    {
        ...
        public Nullable<float> remmax { get; set; }
        public Nullable<double> qtes { get; set; }
        public Nullable<double> stockinitial { get; set; }
        public Nullable<float> stockmin { get; set; }
        public Nullable<float> stockmax { get; set; }
        ...
        public Nullable<float> prixdevice { get; set; }
        ...
        public Nullable<float> stkinitexer { get; set; }
        ...
        public Nullable<float> cours { get; set; }
